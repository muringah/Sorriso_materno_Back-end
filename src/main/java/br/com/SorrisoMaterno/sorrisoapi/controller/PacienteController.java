...
public class PacienteController {
    ...
    public ArrayList<Paciente> listarPacientes(){
         ...
         paciente2.setNome("Gabriely");
         paciente2.setDataNascimento("11/01/2001");
         paciente2.setRg("222.222.222.22");
         paciente2.setGestacoesAnteriores(1);
         paciente2.setEmail("grabriely@gmail.com");
         paciente2.setComplicacoes("sim");
         paciente2.setCpf("528.456.789-44");
         paciente2.setTelefone("11964017013");
